 ...
 * @returns {string} route path
 */
export const apiV1BorrowingsPath: ((
  options?: {format?: OptionalRouteParameter} & RouteOptions
) => string) & RouteHelperExtras;
 ...
 * @returns {string} route path
 */
export const editApiV1BookPath: ((
  id: RequiredRouteParameter,
  options?: {format?: OptionalRouteParameter} & RouteOptions
) => string) & RouteHelperExtras;
 ...
 * @returns {string} route path
 */
export const returnApiV1BorrowingPath: ((
  id: RequiredRouteParameter,
  options?: {format?: OptionalRouteParameter} & RouteOptions
) => string) & RouteHelperExtras;
 ...
 * @returns {string} route path
 */
export const returnBorrowingPath: ((
  id: RequiredRouteParameter,
  options?: {format?: OptionalRouteParameter} & RouteOptions
) => string) & RouteHelperExtras;
